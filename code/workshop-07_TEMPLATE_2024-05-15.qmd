...
The qmd file is within the code file and the abalone growth file is within the data file. 

Note the file path within the `read_csv()` function. How is this different from how we've stored and read data before?  

The function "here" makes the file path much shorter by replacing all the extra file path information that's outside of this project with "here". 
